...
class Bacteria
{
  ...
  void walk()
  {
    ...
    if(!foodFlag1)
    {
      if(mousePressed == true)
      {
        ...
        if(myX < mouseX)
        {
          ...
          {
            //X changes by a value between 0 and 3, inclusive.
            myX = myX + (int)(Math.random()*4);
          }
          else
          {
            //X changes by a value between 0 and -1, inclusive.
        ...
        if(myY < mouseY)
        {
          if( (int)(Math.random()*2) > 0 )
          {
            //Y changes by a value between 0 and 3, inclusive.
            myY = myY + (int)(Math.random()*4);
          }
          else
          {
            //Y changes by a value between 0 and -1, inclusive.
    ...
    {
      //X and Y change by an integer between -3 and 3, inclusive.
